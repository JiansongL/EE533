...
//  /   /         Filename : reg9B.vf
// /___/   /\     Timestamp : 02/06/2026 00:59:19
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family spartan3a -w C:/labs/Lab3Attempt5/reg9B.sch reg9B.vf
//Design Name: reg9B
//Device: spartan3a
//Purpose:
...
module reg9B(ce, 
   ...
   FD16CE_HXILINX_reg9B XLXI_1 (.C(clk), 
                                .CE(ce), 
                                .CLR(clr), 
                                .D(d[15:0]), 
                                .Q(q[15:0]));
